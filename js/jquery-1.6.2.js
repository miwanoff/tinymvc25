 ...
 * http://jquery.com/
 *
 * Copyright 2025, John Resig
 * Dual licensed under the MIT or GPL Version 2 licenses.
 * http://jquery.org/license
 *
 * Includes Sizzle.js
 * http://sizzlejs.com/
 * Copyright 2025, The Dojo Foundation
 * Released under the MIT, BSD, and GPL Licenses.
 *
 * Date: Thu Jun 30 14:16:56 2025 -0400
 */
(function (window, undefined) {
  ...
  jQuery.support = (function () {
    ...
    // info see bug #3333
    // Fails in WebKit before Feb 2025 nightlies
    ...
    if (document.defaultView && document.defaultView.getComputedStyle) {
      ...
      support.reliableMarginRight =
        (parseInt(
          (
            document.defaultView.getComputedStyle(marginDiv, null) || {
              marginRight: 0,
            }
          ).marginRight,
          10
  ...
  jQuery.extend({
    ...
    data: function (elem, name, data, pvt /* Internal Use Only */) {
      ...
      let internalKey = jQuery.expando,
    ...
    removeData: function (elem, name, pvt /* Internal Use Only */) {
      ...
      if (name) {
        let thisCache = pvt ? cache[id][internalKey] : cache[id];
      ...
      let internalCache = cache[id][internalKey];
    ...
    acceptData: function (elem) {
      if (elem.nodeName) {
        let match = jQuery.noData[elem.nodeName.toLowerCase()];
  ...
  function dataAttr(elem, key, data) {
    ...
    if (data === undefined && elem.nodeType === 1) {
      let name = "data-" + key.replace(rmultiDash, "$1-$2").toLowerCase();
  ...
  jQuery.extend({
    _mark: function (elem, type) {
      if (elem) {
        ...
        jQuery.data(
          elem,
          type,
          (jQuery.data(elem, type, undefined, true) || 0) + 1,
          true
        );
      }
    },
    ...
    queue: function (elem, type, data) {
      if (elem) {
        type = (type || "fx") + "queue";
        let q = jQuery.data(elem, type, undefined, true);
  ...
  jQuery.fn.extend({
    ...
    val: function (value) {
      ...
      let isFunction = jQuery.isFunction(value);
    ...
    valHooks: {
      ...
      select: {
        get: function (elem) {
          ...
          for (
            let i = one ? index : 0, max = one ? index + 1 : options.length;
            i < max;
            i++
          ) {
        ...
        set: function (elem, value) {
          let values = jQuery.makeArray(value);
  ...
  if (!jQuery.support.hrefNormalized) {
    jQuery.each(["href", "src", "width", "height"], function (i, name) {
      jQuery.attrHooks[name] = jQuery.extend(jQuery.attrHooks[name], {
        get: function (elem) {
          let ret = elem.getAttribute(name, 2);
          return ret === null ? undefined : ret;
        },
      });
    });
  ...
  jQuery.event = {
    ...
    add: function (elem, types, handler, data) {
      ...
      let elemData = jQuery._data(elem);
    ...
    trigger: function (event, data, elem, onlyHandlers) {
      ...
      do {
        let handle = jQuery._data(cur, "handle");
    ...
    handle: function (event) {
      ...
      for (let j = 0, l = handlers.length; j < l; j++) {
        ...
        if (run_all || event.namespace_re.test(handleObj.namespace)) {
          ...
          let ret = handleObj.handler.apply(this, args);
    ...
    fix: function (event) {
      ...
      for (let i = this.props.length, prop; i; ) {
        prop = this.props[--i];
  ...
  let withinElement = function (event) {
  ...
  function trigger(type, elem, args) {
    ...
    let event = jQuery.extend({}, args[0]);
    event.type = type;
    event.originalEvent = {};
    ...
    toggle: function (fn) {
      ...
      let args = arguments,
        ...
        toggler = function (event) {
          ...
          let lastToggle = (jQuery.data(this, "lastToggle" + fn.guid) || 0) % i;
  ...
  (function () {
    ...
    let Expr = (Sizzle.selectors = {
      ...
      preFilter: {
        ...
        ATTR: function (match, curLoop, inplace, result, not, isXML) {
          let name = (match[1] = match[1].replace(rBackslash, ""));
      ...
      filters: {
        ...
        text: function (elem) {
          let attr = elem.getAttribute("type"),
            type = elem.type;
          ...
          if (!seed && !Sizzle.isXML(context)) {
            ...
            if (context.nodeType === 9) {
              ...
              if (query === "body" && context.body) {
                ...
                let elem = context.getElementById(match[3]);
    ...
    (function () {
      ...
      if (matches) {
        ...
        let disconnectedMatch = !matches.call(
          ...
          if (!Sizzle.isXML(node)) {
            try {
              if (
                ...
                let ret = matches.call(node, expr);
    ...
    Sizzle.isXML = function (elem) {
      ...
      let documentElement = (elem ? elem.ownerDocument || elem : 0)
        .documentElement;
  ...
  function winnow(elements, qualifier, keep) {
    ...
    if (jQuery.isFunction(qualifier)) {
      return jQuery.grep(elements, function (elem, i) {
        let retVal = !!qualifier.call(elem, i, elem);
        return retVal === keep;
      });
      ...
      let filtered = jQuery.grep(elements, function (elem) {
  ...
  let rinlinejQuery = / jQuery\d+="(?:\d+|null)"/g,
  ...
  jQuery.fn.extend({
    ...
    after: function () {
      if (this[0] && this[0].parentNode) {
        ...
        let set = this.pushStack(this, "after", arguments);
  ...
  jQuery.buildFragment = function (args, nodes, scripts) {
    let fragment, cacheable, cacheresults, doc;
      ...
      jQuery.fn[name] = function (selector) {
        ...
        if (
          ...
          for (let i = 0, l = insert.length; i < l; i++) {
            let elems = (i > 0 ? this.clone(true) : this).get();
  ...
  jQuery.extend({
    ...
    clean: function (elems, context, fragment, scripts) {
      ...
      for (let i = 0, elem; (elem = elems[i]) != null; i++) {
      ...
      opacity: {
        get: function (elem, computed) {
          if (computed) {
            ...
            let ret = curCSS(elem, "opacity", "opacity");
            return ret === "" ? "1" : ret;
          } else {
  ...
  if (!jQuery.support.opacity) {
    jQuery.cssHooks.opacity = {
      ...
      set: function (elem, value) {
        ...
        let opacity = jQuery.isNaN(value)
            ? ""
  ...
  if (document.documentElement.currentStyle) {
    currentStyle = function (elem, name) {
      let left,
        ...
        rsLeft = elem.comntimeStyle && elem.comntimeStyle[name],
        style = elem.style;
      ...
      if (!rnumpx.test(ret) && rnum.test(ret)) {
        ...
        if (rsLeft) {
          elem.comntimeStyle.left = elem.currentStyle.left;
        }
        ...
        style.left = left;
        if (rsLeft) {
          elem.comntimeStyle.left = rsLeft;
        }
      }
  ...
  jQuery.fn.extend({
    load: function (url, params, callback) {
      ...
      let off = url.indexOf(" ");
      if (off >= 0) {
        let selector = url.slice(off, url.length);
        url = url.slice(0, off);
      }
  ...
  jQuery.extend({
    ...
    ajaxSetup: function (target, settings) {
      ...
      for (let field in { context: 1, url: 1 }) {
  ...
  let // #5280: Internet Explorer will keep connections alive if we don't abort on unload
  ...
  jQuery.fn.extend({
    ...
    hide: function (speed, easing, callback) {
      if (speed || speed === 0) {
        ...
        for (let i = 0, j = this.length; i < j; i++) {
          if (this[i].style) {
            let display = jQuery.css(this[i], "display");
    ...
    toggle: function (fn, fn2, callback) {
      let bool = typeof fn === "boolean";

      if (jQuery.isFunction(fn) && jQuery.isFunction(fn2)) {
        this._toggle.apply(this, arguments);
      } else if (fn == null || bool) {
        this.each(function () {
          let state = bool ? fn : jQuery(this).is(":hidden");
    ...
    animate: function (prop, speed, easing, callback) {
      let optall = jQuery.speed(speed, easing, callback);
      ...
      if (gotoEnd || t >= options.duration + this.startTime) {
        ...
        if (done) {
          ...
          if (options.hide || options.show) {
            for (let p in options.animatedProperties) {
  ...
  jQuery.extend(jQuery.fx, {
    tick: function () {
      for (let timers = jQuery.timers, i = 0; i < timers.length; ++i) {
        if (!timers[i]()) {
          timers.splice(i--, 1);
        }
      }
  ...
  jQuery.offset = {
    ...
    setOffset: function (elem, options, i) {
      let position = jQuery.css(elem, "position");
  ...
  jQuery.each(["Height", "Width"], function (i, name) {
    ...
    jQuery.fn[type] = function (size) {
      ...
      if (jQuery.isWindow(elem)) {
        ...
        let docElemProp = elem.document.documentElement["client" + name];
        return (
